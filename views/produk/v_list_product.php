                                        ...
                                        <div class="nk-tb-item">
                                            ...
                                            <div class="nk-tb-col nk-tb-col-tools">
                                                <ul class="nk-tb-actions gx-1">
                                                    ...
                                                    <li class="nk-tb-action-hidden"><a onclick="return confirm('Apakah yakin data akan di hapus?')" href="../../routers/r_produk.php?id=<?php echo $data->id ?>&aksi=hapus" class="btn btn-icon btn-trigger btn-tooltip" title="Delete">
